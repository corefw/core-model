...
class MysqlAdapterFactory extends BaseClass {
	...
	getAdapterFieldPresets() {
		...
		presets.ZERO_NULL_DATE = function Preset_ZERO_NULL_DATE( fieldObj, refs ) { // eslint-disable-line camelcase
			...
			if ( _.isNil( fieldObj.defaultValue ) || fieldObj.defaultValue === "" ) {

				fieldObj.defaultValue = "0000-00-00";
			}
		...
		presets.ZERO_NULL_DATETIME = function Preset_ZERO_NULL_DATETIME( fieldObj, refs ) { // eslint-disable-line camelcase
			...
			if ( _.isNil( fieldObj.defaultValue ) || fieldObj.defaultValue === "" ) {
				...
				fieldObj.defaultValue = "0000-00-00 00:00:00";
			}

			// FIXME: Applying a default value breaks automatic timestamp values.
			// Added the following for lack of a better solution at the moment

			if ( refs.fieldName === "created_datetime" ) {

				delete fieldObj.defaultValue;
			}

			if ( refs.fieldName === "updated_datetime" ) {
